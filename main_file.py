...
canvas.pack()
text_var="Alzheimer Disease detection"
...
button1 = tk.Button(root, text="LOGIN", command=log, width=15, height=1,font=('times 15 bold'),bd=5, bg="#A020F0", fg="white")
button1.place(x=920, y=300)

button2 = tk.Button(root, text="REGISTER",command=about,width=15, height=1,font=('times 15 bold'), bd=5,bg="#8F00FF", fg="white")
button2.place(x=920, y=380)

button4 = tk.Button(root, text="EXIT", command=con, width=15, height=1,font=('times 15 bold'),bd=5,bg="red", fg="white")
button4.place(x=920, y=460)
...
label_l1 = tk.Label(root, text="***___Alzheimer Disease detection System @2023 By ___***",font=("Times New Roman", 10, 'bold'),
                    background="black", fg="white", width=200, height=2)
label_l1.place(x=0, y=600)
