...
#
lbl = tk.Label(root, text="Alzheimer Disease detection", font=('times', 35,' bold '), width=45,height=1,bg="#B7B7B7",fg="white")
lbl.place(x=0, y=0)
...
frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=220, height=350, bd=5, font=('times', 14, ' bold '),bg="#C6E2FF")
...
#    global fn
    ...
    if fn!="":
        ...
        if yoga == 0:
            Cd="Mild Alzhimer Detected"
        elif yoga == 1:
            Cd="Moderate Alzhimer Detected"
        elif yoga == 2:
